...
(def people-table
  (atom
   {1 {:person/id 1 :person/name "Sallyr1" :person/age 32}
    2 {:person/id 2 :person/name "Joer1" :person/age 22}
    3 {:person/id 3 :person/name "Fredr1" :person/age 11}
    4 {:person/id 4 :person/name "Bobbyr1" :person/age 55}}))
